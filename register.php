...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (empty($first_name) || empty($last_name) || empty($classe) || empty($marque_vehicule)) {
        ...
        $sql = "INSERT INTO users (first_name, last_name, classe, marque_vehicule, code_badge,  created_at ) 

                VALUES ('$first_name', '$last_name', '$classe', '$marque_vehicule', '$badge_code', '$created_at')";
        ...
        if ($dbConnection->query($sql) === TRUE) {
            ...
            $messageError = "Erreur lors de l'enregistrement : " . $dbConnection->error;
